      ...
      <AnimatePresence mode="wait">
        ...
        {mode === "gate" && (
          ...
          >
            <div className="text-center mb-8">
              <div className="w-16 h-16 rounded-2xl gradient-bg-purple-cyan mx-auto mb-6 flex items-center justify-center">
        ...
        {mode === "signup" && (
          <motion.div
            ...
            className="relative z-10 w-full max-w-md"
          >
            <button onClick={() => setMode("gate")} className="text-sm text-muted-foreground hover:text-foreground mb-6 flex items-center gap-1">
              ← Back
            </button>
        ...
        {(mode === "login" || mode === "admin-login") && (
          ...
          >
            ...
            <GlassCard className="p-8" hover={false}>
              <h2 className="text-display text-2xl text-foreground mb-1">
                {mode === "admin-login" ? "Owner Login" : "Member Login"}
              </h2>
              <p className="text-sm text-muted-foreground mb-6">
                {mode === "admin-login" ? "Access admin dashboard" : "Welcome back to the studio"}
              </p>
              <form onSubmit={handleSignIn} className="flex flex-col gap-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full py-3 rounded-xl font-semibold transition-all duration-300 hover:-translate-y-0.5 disabled:opacity-50 ${
                    mode === "admin-login"
                      ? "bg-accent text-accent-foreground hover:shadow-[0_0_40px_rgba(245,158,11,0.3)]"
                      : "gradient-bg-purple-cyan text-primary-foreground hover:shadow-[0_0_40px_rgba(124,58,237,0.3)]"
                  }`}
                >
